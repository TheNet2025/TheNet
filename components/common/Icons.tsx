...
export const QrCodeIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M3.75 4.5A.75.75 0 014.5 3.75h3c.414 0 .75.336.75.75v3c0 .414-.336.75-.75.75h-3A.75.75 0 013.75 7.5v-3zM4.5 4.5v.001h.001V4.5H4.5zm2.25 0v.001h.001V4.5h-.001zM3.75 10.5a.75.75 0 01.75-.75h3c.414 0 .75.336.75.75v3c0 .414-.336.75-.75.75h-3a.75.75 0 01-.75-.75v-3zM4.5 10.5v.001h.001v-.001H4.5zm2.25 0v.001h.001v-.001h-.001zM3.75 16.5a.75.75 0 01.75-.75h3c.414 0 .75.336.75.75v3c0 .414-.336.75-.75.75h-3a.75.75 0 01-.75-.75v-3zM4.5 16.5v.001h.001v-.001H4.5zm2.25 0v.001h.001v-.001h-.001zM10.5 4.5a.75.75 0 01.75-.75h3c.414 0 .75.336.75.75v3c0 .414-.336.75-.75.75h-3a.75.75 0 01-.75-.75v-3zm.75.001v.001h.001V4.5h-.001zm2.25 0v.001h.001V4.5h-.001zM10.5 10.5a.75.75 0 01.75-.75h3c.414 0 .75.336.75.75v3c0 .414-.336.75-.75.75h-3a.75.75 0 01-.75-.75v-3zm.75.001v.001h.001v-.001h-.001zm2.25 0v.001h.001v-.001h-.001zM10.5 16.5a.75.75 0 01.75-.75h3c.414 0 .75.336.75.75v3c0 .414-.336.75-.75.75h-3a.75.75 0 01-.75-.75v-3zm.75.001v.001h.001v-.001h-.001zm2.25 0v.001h.001v-.001h-.001zM16.5 4.5a.75.75 0 01.75-.75h3c.414 0 .75.336.75.75v3c0 .414-.336.75-.75.75h-3a.75.75 0 01-.75-.75v-3zm.75.001v.001h.001V4.5h-.001zm2.25 0v.001h.001V4.5h-.001zM16.5 10.5a.75.75 0 01.75-.75h3c.414 0 .75.336.75.75v3c0 .414-.336.75-.75.75h-3a.75.75 0 01-.75-.75v-3zm.75.001v.001h.001v-.001h-.001zm2.25 0v.001h.001v-.001h-.001zM16.5 16.5a.75.75 0 01.75-.75h3c.414 0 .75.336.75.75v3c0 .414-.336.75-.75.75h-3a.75.75 0 01-.75-.75v-3zm.75.001v.001h.001v-.001h-.001zm2.25 0v.001h.001v-.001h-.001z" /></svg>
);
...
export const GiftIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M21 11.25v8.25a2.25 2.25 0 01-2.25 2.25H5.25a2.25 2.25 0 01-2.25-2.25v-8.25M12 4.875A2.625 2.625 0 1014.625 7.5H9.375A2.625 2.625 0 1012 4.875zM21 11.25H3v1.875h18v-1.875z" /></svg>
);
...
export const ServerIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M5.25 14.25h13.5m-13.5 0a3 3 0 01-3-3V7.5a3 3 0 013-3h13.5a3 3 0 013 3v3.75a3 3 0 01-3 3m-13.5 0v3.75a3 3 0 003 3h7.5a3 3 0 003-3V14.25m-13.5 0h13.5" /></svg>
);

export const ChartPieIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M10.5 6a7.5 7.5 0 100 15 7.5 7.5 0 000-15z" /><path strokeLinecap="round" strokeLinejoin="round" d="M13.5 10.5H21A7.5 7.5 0 0013.5 3v7.5z" /></svg>
);
...
export const CloudIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 15a4.5 4.5 0 004.5 4.5H18a3.75 3.75 0 001.332-7.257 3 3 0 00-2.666-5.43a4.5 4.5 0 00-9.522 2.162A4.5 4.5 0 002.25 15z" /></svg>
);
